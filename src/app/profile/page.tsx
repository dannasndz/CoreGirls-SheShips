  ...
  if (!session || !profile) {
    return (
      <div className="min-h-screen bg-cream flex flex-col items-center justify-center p-10">
        <h1 className="text-2xl font-extrabold text-dark-purple mb-2 font-heading">
        ...
        <div className="relative z-10 p-5 flex flex-col gap-5 h-full">
          ...
          <div>
            ...
            {profile.groupMemberships.length > 0 ? (
              ...
              <p className="text-white/50 text-xs px-1">No groups yet</p>
            )}
          </div>
          ...
          <div>
            ...
            {events.length > 0 ? (
              ...
              <p className="text-white/50 text-xs px-1">No events yet</p>
            )}
          </div>
            ...
            {profile.quizResult ? (
              <div className="px-3 py-3 rounded-xl bg-white/15">
                ...
                <p className="text-[10px] text-white/60 mt-1.5">
                  Taken {formatDate(profile.quizResult.createdAt)}
                </p>
                <Link
                  href="/quiz/result"
